                  ...
                  <div className="container mx-auto px-8 md:px-10 py-10">
                        <div className="w-full lg:w-[60vw] mx-auto">
                              ...
                              <p className="text-sm text-center mt-4 leading-6">
                                    ...
                                    adipisicing elit. Dolorem, omnis sunt
                                    ducimus et voluptatibus ex commodi
                                    distinctio explicabo molestias, minus, modi
                                    nam accusantium culpa aspernatur atque quam
                                    neque veniam fugiat?
                              </p>
                        </div>
                                    ...
                                    <div className="flex pt-14 pb-8">
                                          {PROJECTS.map((project) => {
                                                return (
                                                      <div
                                                            key={project.id}
                                                            className="px-2 min-w-[100%] sm:min-w-[50%] lg:min-w-[33%]"
                                                      >
                                                            <ProjectCard
                                                                  key={
                                                                        project.id
